                            ...
                            <div class="modal-body" v-for="question in questions">
                                ...
                                <h5 class="mb-2">Ответы:</h5>
                                 ...
                                 <div class="mb-4">
                                    ...
                                    <textarea type="text" v-if="ExplainSelector == 'Текст'" :value="explainText" name="explain" id="explain" class="form-control <?php $__errorArgs = ['explain'];
...
unset($__errorArgs, $__bag); ?>" id="answer_input">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea type="text" v-if="HelpSelector == 'Текст'" :value="helpText" name="help" id="help" class="form-control <?php $__errorArgs = ['help'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
    ...
    const app = {
        ...
        methods: {
            async EditSituation(){
                ...
                const response = await fetch('<?php echo e(route('editQuestionAndAnswer')); ?>',{
                    method: 'post',
                    headers:{
            ...
            async getQuestions(){
                let id = `<?php echo e($questions->id); ?>`;
                const response = await fetch('<?php echo e(route('getQuestionDetail')); ?>',{
                    method: 'post',
                    headers:{
                        'X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>',
                        'content-type':'application/json'
            ...
            async getAnswers(){
                let id = `<?php echo e($questions->id); ?>`;
                const response = await fetch('<?php echo e(route('getAnswersDetail')); ?>',{
                    method: 'post',
                    headers:{
                        'X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>',
                        'content-type':'application/json'
